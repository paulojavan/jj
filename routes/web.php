...
// Rotas para Acompanhamento de Parcelas (apenas usuários com permissão recebimentos)
Route::middleware(['auth', 'check.recebimentos'])->group(function () {
...
Route::middleware(['auth'])->group(function () {
    ...
    // Rotas para funcionarios (apenas administrador)
    Route::middleware(['check.funcionario.access'])->group(function () {
    ...
    // Rotas para funcionalidades dos botões do histórico de pagamentos (apenas usuários com permissão recebimentos)
    Route::middleware(['check.recebimentos'])->group(function () {
    ...
    Route::get('/produtos/venda-info/{saleId}', [ProdutoController::class, 'buscarInformacoesVendaProduto'])->name('produtos.venda.info');
     ...
     // Rotas para Venda Crediário (apenas usuários com permissão vendas_crediario)
     Route::middleware(['check.vendas.crediario'])->group(function () {
    ...
    // Rotas para Pagamentos de Parcelas (apenas usuários com permissão recebimentos)
    Route::middleware(['check.recebimentos'])->group(function () {
