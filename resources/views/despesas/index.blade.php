        ...
        <div class="mt-3">
            ...
            <form id="editarForm">
                ...
                <div class="flex justify-end">
                    <button type="button" id="cancelarEdicao" class="mr-2 bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                        Cancelar
                    </button>
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <form id="editarFixaForm">
                ...
                <div class="flex justify-end">
                    <button type="button" id="cancelarEdicaoFixa" class="mr-2 bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                        Cancelar
                    </button>
                    <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                        Atualizar
