...
@section('content')
    ...
    <form action="{{ route('funcionario.store') }}" method="post" enctype="multipart/form-data" class="form-container">
        @csrf

        <div class="mb-4">
        <label class="form-label" for="name" >Nome:</label>
        <input class="form-input" type="text" name="name" id="name" placeholder="Nome do vendedor" value="{{ old('name') }}" required>
        </div>

        <div class="mb-4">
        <label class="form-label" for="login">Login:</label>
        <input class="form-input" type="text" name="login" id="login" placeholder="login do usuário" value="{{ old('login') }}" required>
        </div>

        <div class="mb-4">
        <label class="form-label" for="password">Senha:</label>
        <input class="form-input" type="password" name="password" id="password" placeholder="senha do usuário" value="{{ old('password') }}" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input class="form-file" id="image" name="image" type="file" accept="image/*" required>
        </div>
        ...
        <input class="btn-green" type="submit" value="cadastrar">
    </form>
